 ...
 * Scopes.
 * <p>
 * A scope stores the mapping from names to {@link Symbol}s. Four kinds of
 * scopes are used:
 * <ul>
...
public abstract class Scope implements Iterable<Symbol> {
    ...
    public void declare(Symbol symbol) {
        ...
        {
            sb.append("lambda (");
            sb.append(symbol.pos.line);
            sb.append(",");
            sb.append(symbol.pos.column);
            sb.append(")");
        }
        else
        {
        ...
        symbols.put(sb.toString(), symbol);
